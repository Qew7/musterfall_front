...
function App() {
  ...
  const focusPlayerId = campaign.players.find((player) => !player.isBot)?.id ?? campaign.players[0]?.id ?? null
  ...
  return (
    <main className="app-shell">
      {screen === 'menu' && <AppHeader apiStatus={apiState.status} metaProgress={metaProgress} />}
